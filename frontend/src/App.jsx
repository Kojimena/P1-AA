...
function App() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://p1-aa-uvg.koyeb.app/turingMachine/${string}`); //hacemos el fetch a la api con la cadena
  ...
  const fetchMachine = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://p1-aa-uvg.koyeb.app/json`); //hacemos el fetch a la api para mostrar la maquina
  ...
  return (
    <div className="flex flex-col w-screen h-screen justify-center items-center bg-gray-100">
      ...
      {showMachine && !showAnswer && (
        <div className='machine flex flex-col w-1/2 h-1/2 justify-start items-center bg-gray-600 rounded-md p-4 overflow-auto'>
      ...
      )}
      {
        showAnswer && !showMachine && (
          <div className='machine flex flex-col h-1/2 justify-center items-center bg-blue-500 rounded-md min-w-[600px] px-4'>
